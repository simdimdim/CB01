use crate::{hounds::presets::Extractor, Index, Links, Next, Title};
...
use std::{borrow::Cow, convert::TryFrom, fmt::Debug, path::PathBuf, str::FromStr};
...
impl Page {
    ...
    pub fn pred(&self) -> String { (self.next_by)() }
